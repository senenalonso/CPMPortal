class AdvicesController < ApplicationController
  ...
  private
    ...
    def advice_params
      params.require(:advice).permit(:problem, :explanation, :before, :after, :improvement1, :unit1, :metric1, :improvement2, :unit2, :metric2, :improvement3, :unit3, :metric3, :component_id)
    end
end
