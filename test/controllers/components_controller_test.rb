...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { category: @component.category, description: @component.description, name: @component.name, project_id: @component.project_id } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { category: @component.category, description: @component.description, name: @component.name, project_id: @component.project_id } }
